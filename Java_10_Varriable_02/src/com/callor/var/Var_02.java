...
public class Var_02 {
	public static void main(String[] args) {
		...
		/*
		 * 이 명령문이 실행되는 순간 이전에 변수에 어떤 일이 있던지 상관없이
		 * 모든 값이 clear되고 intNum1변수에는 55만 담겨 있게 된다.
		 */
		intNum2 = 33;
...
//		System.out.println(intNum1 + " / " + intNum2 + " = " + (intNum1 / intNum2));
		 ...
		 * 어떠한 연산을 수행하든 읽기를 수행하는 변수의 값은 절대 변함이 없다.
		 *
		 * 다만, 어디선가 변수에 또 다른 값을 할당하면 변수 값이 변하게 된다.
		 */
		int intNum3 = 1000;
