...
/*
 * 성적처리를 하기 위해서 반드시 필요한 데이터 : 학번, 국어, 영어, 수학
 * 출력결과를 보기위해서 총점과 평균도 있으면 좋겠다.
 * 좀 더 확장을 하여 학생의 석차항목도 있으면 좋겠다.
 * 
 * 추상화 : 필요한 데이터를 설계
 * private 변수 선언 : VO 클래스의 추상화된 데이터를 저장할 변수들
 * private 변수에 접근하기 위하여 getter, setter method 선언
 * 저장된 데이터를 확인하기 위하여 toString() method도 재정의
 * 
 * spring project에서는 기본생성자, 모든 필드를 포함한 임의생성자를 만들지만,
...
public class ScoreVO {
	...
	/*
	 * toString() method를 재정의하여 한 학생의 성적내용을 문자열로 만들어 return 하도록 하였다.
	 */
	@Override
