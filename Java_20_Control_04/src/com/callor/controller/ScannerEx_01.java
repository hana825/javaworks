...
public class ScannerEx_01 {
	public static void main(String[] args) {
		...
		// Scanner 클래스에 포함된 method를 호출하여 무언가 명령을 수행하기 위한 첫 준비단계
		...
		/*
		 * 선언된 scan object를 instance로 만들어 메모리에 loading하고 사용할 준비가 된 상태
		 * 이때 "scan instance"라고 부른다.
		 * 
		 * new Scanner(System.in)
		 * pc에 연결된 키보드를 Scanner 클래스에게 연결하여 키보드로부터 데이터(값)를 입력받을 수 있도록 한다.
		 * 
		 */
