...
public class VarEx3 {
	...
	public static void main(String[] args) {
		 ...
		 * 하지만 메모리관리, 유효성관리 등이 어렵기 때문에 그렇게 하지 않는다.
		 */
		List<Object> objList;
		
		List<Integer> intList;
		// 데이터의 유효성 검사
		// Integer type만 add할 수 있는 intList에 Float type의 값을 추가하려고 하니 오류가 발생한다.
//		intList.add(30.0f);
		
		/*
		 * stList에는 StudentVO type의 데이터만 추가할 수 있다.
		 * 만약, 다른 type의 데이터가 추가되면 오류가 발생한다.
