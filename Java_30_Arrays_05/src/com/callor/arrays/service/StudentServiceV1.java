...
public class StudentServiceV1 {
	...
	// 기본 생성자 : 클래스를 선언하면 자동으로 선언되는 생성자 메서드
	public StudentServiceV1() {
//		strStudents = new String[10];
//		scan = new Scanner(System.in);
		
		/*
		 * strStudents, scan 두 개의 변수는 초기화가 되어야 하는데 생성자에 초기화시키는 코드를 작성한다.
		 * 하지만 현재 ServiceV1 클래스에는 두 개의 생성자가 있다.
		 * 그래서 기본생성자에서는 임의생성자에게 정수 10을 전달하면서 strStudents 와 scan 두 개의 변수를 초기화 하도록 toss 해버린다.
		 */
		this(10);
		
	}
	
	// 임의 생성자 : 클래스 개발자가 필요에 의해 임의로 선언하는 생성자 메서드
