...
public class Var_02 {
	...
	public static void main(String[] args) {
		 ...
		 * 여기서 %d는 Decimal(10진수)를 표현하는 키 단어이다.
		 * 그런다 doNum1, doNum2, doSum 변수는 double type이다.
		 * double type 변수에 담긴 값을 %d로 표현하려면
		 * 내부에서 데이터 type문제로 인한 중대한 문제가 발생한다.
		 * %d는 정수만 표현할 수 있는데 실수값을 표현하라고 했기 때문에 발생하는 문제이다.
		 */
//		System.out.printf("\t%d + %d = %d\n", doNum1, doNum2, doSum);
		...
		// %.2f : 정수부분은 모두 표기하고 소수점이하 2째자리까지 출력하라
		 ...
		 * 8.2 ; 정수자리수 + 소수점(1) + 소수점이하 2자리를 모두 합한 개수가 8개라는 표현이다.
