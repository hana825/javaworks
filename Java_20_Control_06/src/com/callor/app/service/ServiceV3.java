...
/*
 * scoreSum()에서 계산한 총점과 scorePrint()에서 출력한 과목점수와의 관계에 완전히 문제가 발생했다.
 * 두 method에서 선언된 intKor, intEng, intMath는 이름은 같지만 완전히 다른(저장공간, 값이 다른) 변수이다.
 * 
 * 총점을 scorePrint()에서 직접 계산하면 되겠지만 scoreSum()을 사용하여 총점을 계산하고 싶다
 * 
...
public class ServiceV3 {
	...
	public void scorePrint() {
		...
		// String(문자열) type의 변수의 실체는 String 클래스 type의 인스턴스이다.
		// String 클래스에는 문자열을 다루는 다양한 method들이 이미 준비되어 있다.
