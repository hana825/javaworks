...
public class ServiceV4 {
	 ...
	 * class scope에 선언된 변수는 현재 class의 모든 method에서 공통으로 공유할 수 있다.
	 *************************************************************************************/
	int intKor = 0;
	int intEng = 0;
	int intMath = 0;
	...
	public int scoreSum() {
		/*********************************************************************************
		 * class scope에 선언된 변수에 1~100까지의 정수를 생성하여 저장해두기
		 * 여기에서 저장된 변수 값은 다른 method에서 값을 변경(저장)하기 전에는 
		 * 현재 프로젝트가 종료될 때까지 계속 유지하고 있다.
		 * 여기에서 저장된 변수 값은 scorePrint()에서 읽어서 출력하면 같은 값이 출력된다.
		 *********************************************************************************/
