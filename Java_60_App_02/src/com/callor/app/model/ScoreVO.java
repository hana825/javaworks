...
//	private float fAvg;
	...
	// 필드변수와 관계없이 총점을 계산하여 return하는 method 정의
	// 객체지향에서 이러한 별개의 method를 메시지 라고 한다. 또는 객체의 행위라고 한다.
	// VO.getIntSum() method를 호출하면 3과목의 합계점수를 return한다.
	public int getIntSum() {
		int sum = intKor + intEng + intMath;
		return sum;
	}
	
	// VO.getAvg() method를 호출하면 3과목의 평균을 계산하여 return한다.
	public float getAvg() {
		int sum = getIntSum();
