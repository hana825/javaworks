...
public class ScoreServiceImplV3 extends ScoreServiceImplV2{
	...
	public void saveScore() {
		 ...
		 * 이때 중간에 BufferedOutput라는 파이프를 연결해 두고 애플리케이션에서는 BufferedOutput에게 데이터를 모두 보내어 다른 일을 수행한다.
		 * BufferedOutput와 FileOutput가 협력하여 데이터를 파일에 기록하는 일을 대신 수행해준다.
		 */
		try {
