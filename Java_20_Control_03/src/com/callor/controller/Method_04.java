...
public class Method_04 {
	public static void main(String[] args) {
		...
		// String type으로 'string'이라는 변수 선언
		String string;
		int num1;
		...
		// String type의 변수 strNation1을 선언하고 빈(blank)문자열로 clear
		String strNation1 = "";
		
		// String class type의 인스턴스 strNation2를 선언하고 인스턴스를 초기화(new String()) 하였다.
		String strNation2 = new String();
		
		// ServiceV2 class type의 인스턴스 sV3를 선언하고 인스턴스를 초기화(new ServiceV2()) 하였다.
		ServiceV2 sV3 = new ServiceV2();
		
		
		// ServiceV2 class type의 객체(object)를 선언했다.
		ServiceV2 sV4;
		// 초기화(new ServiceV2())를 실행하여 sV4가 인스턴스 되었다.
		sV4 = new ServiceV2();
		// 사용하기전: 객체, 사용가능한상태: 인스턴스
