...
//		// Syntax error on token ">=", invalid AssignmentOperator. (명령문 미완성 상태)
//		// 연산식 결과 다음으로 수행할 것을 명령해야함.
//		intNum1 >= intNum2;
		
		/***********************************************************************************
		 * boolean type 변수 선언하고
		 * intNum1과 intNum2의 값을 비교( >= )하여 나타나는 결과(true, false)를 변수에 저장
		 ***********************************************************************************/
		boolean bYes = intNum1 >= intNum2;
		System.out.println(bYes);
		
//		산술연산과 비교 연산을 함께 포함하는 연산식(expression)
//		1. intNum1 % 2 가 연산되고
